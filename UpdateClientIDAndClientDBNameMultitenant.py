...
for client_id, database_name in test_data:
    ...
    print(f"exec ps.DeleteClientData @clientID = '{client_id}', @preserveTenantConfig = 0")
    print("use perfrm_ps_catalog")
    print(f"exec dbo.RemoveClientFromDatabase @clientID = '{client_id}', @database = '{database_name}'")
